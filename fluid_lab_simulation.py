...
if module == "Pitot Tube Flow":
    ...
    with st.expander("🖼️ Schematic Diagram"):
        st.image("https://i.imgur.com/R7LqiyW.png", caption="Pitot Tube Setup", use_column_width=True)  # Replace with actual schematic URL
...
# --- REYNOLDS NUMBER MODULE ---
    ...
    with st.expander("🖼️ Schematic Diagram"):
        st.image("https://i.imgur.com/6CibJ2e.png", caption="Flow Regimes in Pipe", use_column_width=True)  # Replace with actual schematic URL
